...
response=$(curl --write-out %{http_code} --silent --output /dev/null https://github.com/npiper/jdk8)
...
if [[ "$response" -ne 200 ]] ; then
  printf "npiper/jdk8 repository has not been created .. trying to create using git creds"
  
  printf "npiper/jdk8 repository has not been created - to create try using either of these"
...
git remote add origin https://github.com/npiper/jdk8.git
